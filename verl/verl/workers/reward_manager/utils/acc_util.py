...
if not VERIFIER_SERVER or not VERIFIER_PATH or not VERIFIER_API_KEY:
...
def request_model(prompt):
    client = openai.Client(base_url=VERIFIER_SERVER, api_key=VERIFIER_API_KEY)  # sglang为None，vllm为Empty
