...
def get_ppo_ray_runtime_env():
    ...
    # add
    for key in ["SWANLAB_API_KEY", "SWANLAB_LOG_DIR", "SWANLAB_MODE", "SGLANG_LOG_LEVEL", "HYDRA_FULL_ERROR", "DIST_INIT_METHOD", "VERIFIER_SERVER", "VERIFIER_PATH", "VERIFIER_PATH"]:
        val = os.getenv(key)
        if val is not None:
